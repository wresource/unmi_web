...
export default defineEventHandler(async (event) => {
  ...
  return {
    ...
    data: {
      ...
      registrant_email: whois?.registrantEmail || '',
      registrant_phone: whois?.registrantPhone || '',
      registrant_country: whois?.registrantCountry || '',
      registrant_province: whois?.registrantProvince || '',
      registrant_city: whois?.registrantCity || '',
      registrant_address: whois?.registrantAddress || '',
      admin_name: whois?.adminName || '',
      admin_email: whois?.adminEmail || '',
      tech_name: whois?.techName || '',
      tech_email: whois?.techEmail || '',
    },
    whois: whois
      ? {
          ...
          registrantAddress: whois.registrantAddress,
          registrantCity: whois.registrantCity,
          registrantProvince: whois.registrantProvince,
          adminName: whois.adminName,
          adminEmail: whois.adminEmail,
          techName: whois.techName,
          techEmail: whois.techEmail,
          privacyProtection: whois.privacyProtection,
          source: whois.source,
